...
export default function AgendaList() {
  ...
  if (loading) return <div className="state">Cargando agenda...</div>;
  if (err) return <div className="state error">Error: {err}</div>;
  if (!sortedItems.length) return <div className="state">No hay clientes disponibles para agenda.</div>;
    ...
    <div className="adminUsersWrap">
      <section className="adminPanel">
        <div className="adminUsersHead">
          <div>
            <h2 className="adminTitle">Agenda por cliente</h2>
            <p className="adminSub">Selecciona un cliente para ver y gestionar sus actividades.</p>
          </div>
        </div>
                ...
                <tr key={client.slug}>
                  ...
                  <td>
                    <div className="adminRowActions">
                      <Link className="adminBtn adminBtnLink" to={`/agenda/${client.slug}`}>
                        Abrir agenda
                      </Link>
